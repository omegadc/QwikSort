...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("QwikSort", u"QwikSort", None))
        # self.actionOpen_Rulesets.setText(QCoreApplication.translate("QwikSort", u"Open Rulesets", None))
        self.actionExit.setText(QCoreApplication.translate("QwikSort",u"&Exit",None))
        self.actionRulesetImport.setText(QCoreApplication.translate("QwikSort", u"Import Ruleset", None))
        self.actionExport_Ruleset.setText(QCoreApplication.translate("QwikSort", u"Export Ruleset", None))
        self.actionOpen_Folder.setText(QCoreApplication.translate("QwikSort", u"Open Folder", None))
#endif // QT_CONFIG(shortcut)
        self.actionCreate_New_Folder.setText(QCoreApplication.translate("QwikSort", u"Create New Folder", None))
#endif // QT_CONFIG(shortcut)
        self.actionDelete_Folder.setText(QCoreApplication.translate("QwikSort", u"Delete Folder", None))
        self.actionUndo.setText(QCoreApplication.translate("QwikSort", u"Undo", None))
        self.actionCreate_New_Restore_Point.setText(QCoreApplication.translate("QwikSort", u"Create New Restore Point", None))
        self.actionRestore_Back_to_Restore_Point.setText(QCoreApplication.translate("QwikSort", u"Revert to Restore Point", None))
        self.actionTutorial.setText(QCoreApplication.translate("QwikSort", u"Tutorial", None))
        # self.actionUninstall.setText(QCoreApplication.translate("QwikSort", u"Uninstall", None))
        self.actionLight_Dark_Mode.setText(QCoreApplication.translate("QwikSort", u"Light/Dark Mode", None))
        self.btnClear.setText(QCoreApplication.translate("QwikSort", u"Clear", None))
        self.btnPlus.setText(QCoreApplication.translate("QwikSort", u"+", None))
        self.label_3.setText(QCoreApplication.translate("QwikSort", u"Rules", None))
        self.pushbttn_matchAll.setText(QCoreApplication.translate("QwikSort", u"Match All", None))
        self.pushbttn_matchOne.setText(QCoreApplication.translate("QwikSort", u"Match One", None))
        # self.pushButton_6.setText(QCoreApplication.translate("QwikSort", u"Save", None))
        # self.pushButton_7.setText(QCoreApplication.translate("QwikSort", u"Load", None))
        self.pushButton_4.setText(QCoreApplication.translate("QwikSort", u"Delete Files", None))
        self.pushButton_5.setText(QCoreApplication.translate("QwikSort", u"Sort", None))
        self.label.setText(QCoreApplication.translate("QwikSort", u"Target Directory", None))
        self.pushbtn_Dir.setText(QCoreApplication.translate("QwikSort", u"...", None))
        self.label_2.setText(QCoreApplication.translate("QwikSort", u"Files", None))
        self.pushButton.setText(QCoreApplication.translate("QwikSort", u"Sort?", None))
        self.pushButton_2.setText(QCoreApplication.translate("QwikSort", u"<", None))
        self.pushButton_3.setText(QCoreApplication.translate("QwikSort", u">", None))
        self.menuFile.setTitle(QCoreApplication.translate("QwikSort", u"File", None))
        self.menuRulesets.setTitle(QCoreApplication.translate("QwikSort", u"Rulesets", None))
        self.menuRollback.setTitle(QCoreApplication.translate("QwikSort", u"Rollback", None))
        self.menuHelp.setTitle(QCoreApplication.translate("QwikSort", u"Help", None))
        # self.menuPreferences.setTitle(QCoreApplication.translate("QwikSort", u"Preferences", None))
    # retranslateUi
